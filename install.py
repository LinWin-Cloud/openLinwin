...
def Install():
    ...
    if a == "n" or a == "N":
        ...
        if os.path.exists('/usr/LinWinHttp') and os.path.isfile("/usr/LinWinHttp"):
        ...
        def a():
            ...
            os.system("cd /usr/LinWinHttp/JRE && unzip -o openJDK8.zip")	
            os.system('cd /usr/LinWinHttp/nodeJS && unzip -o linux.zip')
            ...
            os.system('rm -f /usr/LinWinHttp/nodeJS/linux.zip')
            os.system('rm -f /usr/LinWinHttp/JRE/openJDK8.zip')
